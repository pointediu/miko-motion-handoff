...
/// V8 贴纸揭晓。所有时间以秒计、距离以 pt 计，角度以度计。
enum RewardPopupV8Parameters {
    static let duration = 3.4
    static let reducedMotionDuration = 0.18
    static let closeDuration = 0.16
    static let buttonReadyTime = 1.4
    static let recommendedHapticTime = 1.4
    ...
    static let tracks: [String: [Keyframe]] = [
        ...
        "cardX": [.init(time: 0, value: -34), .init(time: 0.42, value: 0)],
        "cardY": [.init(time: 0, value: -100), .init(time: 0.42, value: 0)],
        "cardScale": [.init(time: 0, value: 1.06), .init(time: 0.42, value: 1)],
        "cardRotation": [.init(time: 0, value: -9), .init(time: 0.42, value: 0)],
        "adhesion": [.init(time: 0, value: 0), .init(time: 0.42, value: 0), .init(time: 0.6, value: 0.05), .init(time: 1.05, value: 0.66), .init(time: 1.28, value: 0.91), .init(time: 1.4, value: 1)],
        "curlAngle": [.init(time: 0, value: 72), .init(time: 0.6, value: 72), .init(time: 1.05, value: 50), .init(time: 1.4, value: 0)],
        "shadowOpacity": [.init(time: 0, value: 0.18), .init(time: 0.6, value: 0.15), .init(time: 1.4, value: 0)],
        "shadowBlur": [.init(time: 0, value: 22), .init(time: 0.6, value: 16), .init(time: 1.4, value: 0)],
        "shadowY": [.init(time: 0, value: 20), .init(time: 0.6, value: 14), .init(time: 1.4, value: 0)],
        "reveal": [.init(time: 0, value: 1)],
        "lineOpacity": [.init(time: 0, value: 0)],
        "glow": [.init(time: 0, value: 0), .init(time: 1.4, value: 0), .init(time: 1.85, value: 0.6), .init(time: 2.6, value: 0.6), .init(time: 3.4, value: 0)],
        "spark": [.init(time: 0, value: 0), .init(time: 1.4, value: 0), .init(time: 1.84, value: 0.6), .init(time: 2.6, value: 0.6), .init(time: 3.4, value: 0)],
        "buttonOpacity": [.init(time: 0, value: 0), .init(time: 0.92, value: 0), .init(time: 1.2, value: 1)],
        "buttonY": [.init(time: 0, value: 16), .init(time: 0.92, value: 16), .init(time: 1.22, value: -2), .init(time: 1.4, value: 0)],
        "buttonScale": [.init(time: 0, value: 0.94), .init(time: 0.92, value: 0.94), .init(time: 1.22, value: 1.025), .init(time: 1.4, value: 1)],
    ]

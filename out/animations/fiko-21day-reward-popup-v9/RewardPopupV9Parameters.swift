...
/// V9 轻弹 · 蓝光白星。所有时间以秒计、距离以 pt 计，角度以度计。
enum RewardPopupV9Parameters {
    ...
    static let tracks: [String: [Keyframe]] = [
        ...
        "cardY": [.init(time: 0, value: 48), .init(time: 0.44, value: -9), .init(time: 0.65, value: 2), .init(time: 0.8, value: 0)],
        "cardScale": [.init(time: 0, value: 0.56), .init(time: 0.44, value: 1.075), .init(time: 0.65, value: 0.985), .init(time: 0.8, value: 1)],
        "cardRotation": [.init(time: 0, value: 0)],
        "adhesion": [.init(time: 0, value: 1)],
        "curlAngle": [.init(time: 0, value: 0)],
        "shadowOpacity": [.init(time: 0, value: 0.16), .init(time: 0.8, value: 0)],
        "shadowBlur": [.init(time: 0, value: 20), .init(time: 0.8, value: 0)],
        "shadowY": [.init(time: 0, value: 14), .init(time: 0.8, value: 0)],
